        ...
        <form id="referralform">
        		...
        		<div class="row">
        		  <div class="col-md-6">
                   ...
                   <input type="text" class="form-control" placeholder="Provider" name="ref_name" id="edit_task_provider" data-toggle='modal'  data-target='#myProviderModal' onclick="searchprovider(this.id)" value=""/>
                   <span class="input-group-addon">
