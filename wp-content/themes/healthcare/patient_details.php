...
<div class="col-md-4">
		...
		<div class="row">
		    <div class="col-md-12">
		        <div class="col-md-4">
				  <div class="form-group ">
				    <label  for="email  " class="set-lebel">Perfered Contact:</label>
...
<br/> 
 ...
 <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-8">
                                  <div class="form-group">
                                    <label for="email" class="set-lebel">Client Consent:</label>

                                    <label class="radio-inline"><input type="radio" name="client_consent"  value="not_answered"  <?php if(($patientsDeatils['client_consent']!= 'yes') && ($patientsDeatils['client_consent']!= 'no')) { echo "checked"; } ?>>Not Answered</label>
...
<?php if($patientsDeatils['client_consent'] == 'yes') {?>
  <div class="panel panel-default">
    <div class="panel-heading">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">
        ...
        <input type="text"  name="location" id="ptn_location" class="form-control" placeholder="Location">
      </th>
      <th scope="col">
...
$(window).on("load", function () {
	...
	//var dataId = $(".need_obs:last").attr('href');
		//dataId = dataId+1;
		//alert(dataId);
    getAssesment(idd);
});
